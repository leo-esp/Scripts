...
alias cdw='cd ~/SuperWorkspace/$WS'

alias cdccb='cd ~/SuperWorkspace/$WS/corretora-core-back'
alias cdccf='cd ~/SuperWorkspace/$WS/corretora-core-front'
alias cdcct='cd ~/SuperWorkspace/$WS/corretora-core-trusted'
alias cdpv='cd ~/SuperWorkspace/$WS/portal-valemobi'
alias cdp='cd ~/SuperWorkspace/$WS/portal'
alias cdvc='cd ~/SuperWorkspace/$WS/valebroker-coldfusion'
alias cdvct='cd ~/SuperWorkspace/$WS/valebroker-coldfusion-trusted'
alias cdvfe='cd ~/SuperWorkspace/$WS/valebroker-flex-extras'
alias cdvfw='cd ~/SuperWorkspace/$WS/valebroker-flex-web'
alias cdvh='cd ~/SuperWorkspace/$WS/valebroker-html'
alias cdvhw='cd ~/SuperWorkspace/$WS/valebroker-html-web'
...
alias letsgo='code ~/SuperWorkspace/$WS && 1all'
